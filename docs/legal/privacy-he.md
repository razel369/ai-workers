...
**לבעלי עסקים בפלטפורמה:** אפשר לייצא או למחוק מידע של לקוח קצה ישירות מהחשבון
(`/api/account/data-export`, `/api/account/data-delete`), לפי טלפון, אימייל או
מזהה שיחה.

**תקופת שמירה:** תמלילי שיחות, סיכומים ורישומי פעולה נמחקים אוטומטית בתום תקופת
השמירה שהוגדרה בחשבון (ברירת מחדל: 365 יום). לידים נשמרים כרשומות עסקיות של
העסק ואינם נמחקים אוטומטית. גיבויים מוצפנים נשמרים לתקופה קצובה נוספת ונמחקים
בתום מחזור הגיבוי.

**הסכם עיבוד נתונים:** ראו `/dpa`.
