...
נתונים נשמרים בשרת מאובטח (SQLite ותיקיות דיירים על דיסק קבוע של ספק האירוח, למשל Render). גישת אדמין מוגנת ב-\`ADMIN_TOKEN\`. מומלץ לסובב מפתחות API לאחר חשיפה.
...
לשאלות משפטיות או חיוב: פנו לכתובת התמיכה בדף פרטי התשלום או ב-\`AGENT_OWNER_CONTACT\`.`,
};
